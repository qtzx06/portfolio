...
const Portfolio = () => {
  ...
  return (
    <div id="portfolio" ref={ref} className="relative h-screen w-screen bg-white">
      <motion.div
        className="w-full h-full flex flex-col items-center justify-center px-[10vw] text-center"
